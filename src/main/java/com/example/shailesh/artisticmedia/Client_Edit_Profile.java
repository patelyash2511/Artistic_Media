...
public class Client_Edit_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String FirstTime= preferences.getString("FIRSTIME","");

        if (FirstTime.equals("Yes")){
            Intent intent=new Intent(Client_Edit_Profile.this,ClientActivity.class);
            startActivity(intent);
        }
        else{
            SharedPreferences.Editor editor=preferences.edit();
            editor.putString("FIRSTIME","Yes");
            editor.apply();
        }
        ...
        savebio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ProgressDialog progressDialog = new ProgressDialog(Client_Edit_Profile.this);
                ...
                databaseReference.updateChildren(usermap).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Client_Edit_Profile.this, "error occured", Toast.LENGTH_SHORT).show();
                        }
                ...
                if(filepath != null) {
                    ...
                    final ProgressDialog progressDialog1 = new ProgressDialog(Client_Edit_Profile.this);
                    ...
                    Task<Uri> uriTask=uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()){
                                ...
                                Intent ii=new Intent(Client_Edit_Profile.this,ClientActivity.class);
                                startActivity(ii);
                    ...
                    Toast.makeText(Client_Edit_Profile.this, "No File Selected", Toast.LENGTH_SHORT).show();
                }
